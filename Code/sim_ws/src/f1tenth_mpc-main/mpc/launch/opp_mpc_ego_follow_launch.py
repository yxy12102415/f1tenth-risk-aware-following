    ...
    return LaunchDescription([
        ...
        Node(
            ...
            parameters=[{
                ...
                'hybrid_astar_time_budget_ms': 120.0,
                'target_heading_alpha': 0.15,
                'target_heading_min_speed': 0.4,
                'goal_yaw_weight': 0.25,
                ...
                'cbf_q_accel': 1.0,
                'cbf_q_steer': 30.0,
                'mpc_steer_input_cost': 20.0,
                'mpc_steer_rate_cost': 70.0,
            }],
            output='screen',
        ),
        Node(
